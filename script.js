  ...
  if (nav) {
    ...
    langSwitcher.innerHTML = `
      ...
      <a href="${arUrl}" class="lang-flag ${isAr ? 'is-active' : ''}" title="العربية" aria-label="العربية">
        <svg viewBox="0 0 36 24" width="28" height="19"><rect width="12" height="24" fill="#006233"/><rect x="12" width="12" height="24" fill="#fff"/><rect x="24" width="12" height="24" fill="#D21034"/><path d="M18,5a7,7 0 1,0 0,14a7,7 0 1,0 0,-14" fill="none" stroke="#D21034" stroke-width="0.5"/><circle cx="18" cy="12" r="5.5" fill="#D21034"/><circle cx="19.5" cy="12" r="4.5" fill="#fff"/><polygon points="16,9 16.8,11.5 14.5,10 17.5,10 15.2,11.5" fill="#D21034" transform="translate(1,1.5) scale(0.8)"/></svg>
      </a>
    `;
